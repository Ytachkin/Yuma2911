...
class KeyValueStorage():
    ...
    def __init__(self, filename):
        ...
        self.working_with_file()

    def working_with_file(self):
        with open(self.filename) as f:
            while True:
                ...
                #We divide them into attributes and add them to the dictionary as a key value
                if hasattr(self, line[0]) is False:
                    setattr(self, line[0], line[1])
                    self.Storege[line[0]] = line[1]

    #iterator
    def __getitem__(self, key):
        return self.Storege[key]