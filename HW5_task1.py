...
if __name__ == '__main__':
    teacher = Teacher('Inna', 'Evgenia')
    student = Student('Danila', 'Ytochka')
    teacher.last_name  # Inna
    student.first_name  # Ytockha

    # set the number of days to execute 0
    expired_homework = teacher.create_homework('Learn functions', 0)
    expired_homework.created  # Example: 2022-04-14 16:44:30.688762
    expired_homework.deadline  # 0:00:00
    expired_homework.text  # 'Learn functions'

    # create function from method and use it
    create_homework_too = teacher.create_homework
    # number of days to execute 5
    oop_homework = create_homework_too('create 2 simple classes', 5)
    oop_homework.deadline  # 5 days, 0:00:00

    # There are still 5 days left before the task is completed.
    student.do_homework(oop_homework)
    # before is completed 0 days, so return False
